...
export default function Contact() {
  ...
  useEffect(() => {
    ...
    const createSparkle = (x, y) => {
      for (let i = 0; i < 3; i++) {
        ...
        sparkle.className = "cursor-sparkle contact-sparkle";
    ...
    const isOverContent = (x, y) => {
      ...
      return elements.some(el =>
        el.closest(".contact-form-area") || el.closest(".contact-info-area")
      );
    };

    const onMove = (e) => {
      if (isOverContent(e.clientX, e.clientY)) return;
  ...
  return (
    <section id="Contact">
      <div ref={areaRef} className="container-fluid bg-black text-white py-5 position-relative sparkle-area contact-sparkle-area">
        ...
        <div className="container position-relative" style={{ zIndex: 2 }}>
          ...
          <div className="row g-5">
            ...
            {/* LEFT SIDE */}
            <motion.div
              className="col-12 col-md-5 contact-info-area"
            ...
            {/* RIGHT SIDE FORM */}
            <motion.div
              className="col-12 col-md-7 contact-form-area"
              initial={{ opacity: 0, y: 40 }}
              whileInView={{ opacity: 1, y: 0 }}

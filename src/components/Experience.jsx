...
const Experience = () => {
  ...
  useEffect(() => {
    ...
    const createSparkle = (x, y) => {
      for (let i = 0; i < 3; i++) {
        ...
        sparkle.className = "cursor-sparkle experience-sparkle";
    ...
    const isOverCard = (x, y) => {
      ...
      return elements.some(el =>
        el.closest(".experience-card")
      );
    };

    const onMove = (e) => {
      if (isOverCard(e.clientX, e.clientY)) return;
  ...
  return (
    <section id="experience" ref={sectionRef} className="bg-dark text-white pb-4 experience-section sparkle-area">

...
function Services() {
    ...
    useEffect(() => {
        ...
        const createSparkle = (x, y) => {
            for (let i = 0; i < 3; i++) {
                ...
                sparkle.className = "cursor-sparkle services-sparkle";
        ...
        const isOverCard = (x, y) => {
            ...
            return elements.some(el =>
                el.closest(".service-item") || el.closest(".card_update")
            );
        };
    ...
    return (
        <section id="Services" ref={sectionRef} className="services-section sparkle-area">
